...
import static com.lambda.investing.algorithmic_trading.quoting.QuoteSideManager.MAX_SIZE_LAST_CLORDID_SENT;
...
//            if (lastWarnLog == null || (algorithm.getCurrentTime().getTime() - lastWarnLog.getTime()) > MAX_LAST_WARN_TIMEOUT_MS) {
//                lastWarnLog = this.algorithm.getCurrentTime();
//                logger.warn("[{}] newBidCrossSpread : new bid {} >=  {} previous ask => update first the ask", this.algorithm.getCurrentTime(), this.lastQuoteRequest.getBidPrice(),
