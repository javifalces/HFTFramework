...
public class ZeroMqMarketDataConnectorApp {
	...
	public static void main(String[] args) {
		try {
			new ZeroMqMarketDataConnectorApp(args);
		} catch (Throwable t) {
			t.printStackTrace();
			System.exit(-1);
		}
	...
	protected ZeroMqMarketDataConnectorApp(String[] springApplicationContextFiles) {
