...
public class ApplicabilityTester {
	...
	private enum Testable {
		CLASSIFIER, ATTRIBUTE_SEARCH, ATTRIBUTE_EVAL
	}
	 ...
	 */
	public static ApplicableClassifiers getApplicableClassifiers(Instances instances, String baseDir,
			List<String> allowed) {
	...
	public static List<ClassParams> getApplicableAttributeEvaluators(Instances instances, String paramDirName) {
		return getApplicable(instances,
				paramDirName + File.separator + "attribselection" + File.separator + "eval" + File.separator,
				Testable.ATTRIBUTE_EVAL, null, null);
	}
	...
	public static List<ClassParams> getApplicableAttributeSearchers(Instances instances, String paramDirName) {
		return getApplicable(instances,
				paramDirName + File.separator + "attribselection" + File.separator + "search" + File.separator,
				Testable.ATTRIBUTE_SEARCH, null, null);
	}
