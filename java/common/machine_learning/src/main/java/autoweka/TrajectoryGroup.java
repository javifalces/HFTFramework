 ...
 */
@XmlRootElement(name = "trajectorygroup") @XmlAccessorType(XmlAccessType.NONE) public class TrajectoryGroup
		extends XmlSerializable {

	@XmlElement(name = "experiment") private Experiment mExperiment;
	@XmlElement(name = "trajectories") private ArrayList<Trajectory> mTrajectories = new ArrayList<Trajectory>();
