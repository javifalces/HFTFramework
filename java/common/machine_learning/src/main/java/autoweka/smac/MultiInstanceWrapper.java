...
public class MultiInstanceWrapper extends SMACWrapper {
	...
	@Override protected ClassifierResult _doRun(List<String> runnerArgs) {
		...
		for (String instance : instances) {
			...
			SubProcessWrapper.ErrorAndTime errTime = SubProcessWrapper
					.getErrorAndTime(null, memory, props, mTimeout, instance, Util.joinStrings(" ", runnerArgs),
							mExperimentSeed);
