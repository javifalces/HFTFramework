...
class ExperimentRunner {
	...
	public static void main(String[] args) {
		...
		String[] oldFiles = new String[] { expName + ".trajectories." + seed, "trained." + seed + ".model",
				"trained." + seed + ".attributeselection", "predictions." + seed };
		...
		String[] runnerArgs = new String[] { expFolder + File.separator + expName + ".trajectories." + seed,
				"-savemodel" };
