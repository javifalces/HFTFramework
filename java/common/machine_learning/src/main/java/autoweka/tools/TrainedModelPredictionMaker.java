...
public class TrainedModelPredictionMaker {
	...
	public static void main(String[] argsArray) {
		...
		TrainedModelPredictionMaker tmpm = new TrainedModelPredictionMaker(attributeSelectionObjPath, modelObjPath,
				instancesPath, classIndex, predictionPath);
	...
	public TrainedModelPredictionMaker(String attributeSelectionObjPath, String modelObjPath, String instancesPath,
			String classIndex, String predictionPath) {
		...
		try {
			...
			if (attributeSelectionObjPath != null) {
				AttributeSelection as = (AttributeSelection) weka.core.SerializationHelper
						.read(attributeSelectionObjPath);
			...
			ClassifierRunner.EvaluatorThread thrd = new ClassifierRunner.EvaluatorThread(eval, classifier, instances,
					predictionPath);
			thrd.run();
		} catch (Exception e) {
