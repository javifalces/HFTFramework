 ...
 */
@XmlRootElement(name = "listExperimentBatch") @XmlAccessorType(XmlAccessType.NONE) class ListExperimentBatch
		extends XmlSerializable {

	final static Logger log = LoggerFactory.getLogger(ListExperimentBatch.class);

	@XmlRootElement(name = "experiment") @XmlAccessorType(XmlAccessType.NONE) static public class ListExperimentComponent {
	...
	@XmlElement(name = "datasetComponent") List<ExperimentBatch.DatasetComponent> mInstances;

	@XmlElement(name = "listExperimentComponent") List<ListExperimentComponent> mExperiments;
	 ...
	 */
	public static ListExperiment createListExperiment(ListExperimentComponent expComp,
