...
public class ClassifierResult {
	...
	private static Metric getMetricFromString(String className) {
		...
		String metricName =
				"autoweka.ClassifierResult$" + className.substring(0, 1).toUpperCase() + className.substring(1)
						+ "Metric";
		try {
	...
	public String getDescription() {
		return "Attribute Selection Time: " + mAttributeSelectionTime + " Training Time: " + mTrainingTime
				+ " Evaluation Time: " + mEvaluationTime + " Score: " + getScore() + " Completed: " + mCompleted;
	}
