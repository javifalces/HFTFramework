 ...
 */
@XmlRootElement(name = "trajectory") @XmlAccessorType(XmlAccessType.NONE) public class Trajectory {

	/**
	 * Representation of a single point along the optimisation run
	 */
	@XmlRootElement(name = "point") @XmlAccessorType(XmlAccessType.NONE) public static class Point {

		/**
		 * The time that this point was found by the SMBO method
		 */
		@XmlElement(name = "time") public double mTime;
		/**
		 * The estimate of the error at this point in the trajectory that the SMBO method believes is true
		 */
		@XmlElement(name = "errorEstimate") public double mErrorEstimate;
		/**
		 * The arg string that was used for the wrapper on this trajectory point
		 */
		@XmlElement(name = "args") public String mArgs;
		/**
		 * Any extra data (aka trajectoryPointExtras) on given instance strings for this point
		 */
		@XmlElement(name = "specificInstanceInfo") public ArrayList<SpecificInstanceInfo> specificInstanceInfo = new ArrayList<SpecificInstanceInfo>();

		/**
		 * Class used to store this extra data
		 */
		@XmlRootElement(name = "specific") @XmlAccessorType(XmlAccessType.NONE) public static class SpecificInstanceInfo {
			...
			@XmlElement(name = "error") public double error;
			@XmlElement(name = "time") public double time;
		}
	 ...
	 */
	@XmlElement(name = "point") private List<Point> mPoints = new ArrayList<Point>();

	/**
	 * The seed of this trajectory
	 */
	@XmlElement(name = "seed") private String mSeed = "0";

	/**
	 * The number of evaluations that were evaluated total in this run
	 */
	@XmlElement(name = "numEvaluatedEvaluations") private int mNumEvaluations = -1;

	/**
	 * The number of evaluations that hit their memory limit in this run
	 */
	@XmlElement(name = "numMemOutEvaluations") private int mNumMemOutEvaluations = -1;

	/**
	 * The number of evaluations that timed out in this run
	 */
	@XmlElement(name = "numTimeOutEvaluations") private int mNumTimeOutEvaluations = -1;
