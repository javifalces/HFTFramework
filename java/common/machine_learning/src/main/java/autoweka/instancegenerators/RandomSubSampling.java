...
public class RandomSubSampling extends InstanceGenerator {
	...
	private static class RegressionResample extends Resample {
		...
		public void createSubsampleWithReplacement(Random random, int origSize, int sampleSize, int ignored,
				int[] classIndices) {
		...
		public void createSubsampleWithoutReplacement(Random random, int origSize, int sampleSize, int ignored,
				int[] classIndices) {
		...
		@Override protected void createSubsample() {
