 ...
 * @author Eibe Frank
 */
@JsonTypeName("RationalTanh") public class ActivationRationalTanh
		extends Activation<org.nd4j.linalg.activations.impl.ActivationRationalTanh> implements OptionHandler {
