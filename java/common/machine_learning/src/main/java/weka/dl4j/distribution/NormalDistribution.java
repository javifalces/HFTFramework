 ...
 * @author Steven Lang
 */
@JsonTypeName("normal") public class NormalDistribution
		extends Distribution<org.deeplearning4j.nn.conf.distribution.NormalDistribution> implements OptionHandler {
