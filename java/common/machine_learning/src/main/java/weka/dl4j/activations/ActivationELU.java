 ...
 * @author Steven Lang
 */
@JsonTypeName("ELU") public class ActivationELU extends Activation<org.nd4j.linalg.activations.impl.ActivationELU>
	...
	@OptionMetadata(displayName = "alpha", description = "The alpha value (default = " + DEFAULT_ALPHA
			+ ").", commandLineParamName = "alpha", commandLineParamSynopsis = "-alpha <double>", displayOrder = 1) public double getAlpha() {
		return alpha;
	}
	...
	@Override public org.nd4j.linalg.activations.impl.ActivationELU getBackend() {
		return new org.nd4j.linalg.activations.impl.ActivationELU(alpha);
	}

	@Override public void setBackend(org.nd4j.linalg.activations.impl.ActivationELU newBackend) {
