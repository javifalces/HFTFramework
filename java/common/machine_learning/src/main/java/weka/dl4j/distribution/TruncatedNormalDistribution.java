 ...
 * @author Steven Lang
 */
@JsonTypeName("truncatednormal") public class TruncatedNormalDistribution
		extends Distribution<org.deeplearning4j.nn.conf.distribution.TruncatedNormalDistribution>
