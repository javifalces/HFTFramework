 ...
 * @author Eibe Frank
 */
@JsonTypeName("MixtureDensity") public class LossMixtureDensity
		extends LossFunction<org.nd4j.linalg.lossfunctions.impl.LossMixtureDensity> implements OptionHandler {
