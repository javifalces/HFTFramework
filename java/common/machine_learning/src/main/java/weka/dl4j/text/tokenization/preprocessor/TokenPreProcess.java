 ...
 * @author Steven Lang
 */
@EqualsAndHashCode @ToString public abstract class TokenPreProcess<T extends org.deeplearning4j.text.tokenization.tokenizer.TokenPreProcess>
	...
	public static TokenPreProcess<? extends org.deeplearning4j.text.tokenization.tokenizer.TokenPreProcess> create(
		...
		return ApiWrapperUtil
				.getImplementingWrapper(TokenPreProcess.class, newBackend, "weka.dl4j.text.tokenization.preprocessor");
	}
