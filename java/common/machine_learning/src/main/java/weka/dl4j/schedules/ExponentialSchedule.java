 ...
 * @author Steven Lang
 */
@EqualsAndHashCode(callSuper = true) @ToString public class ExponentialSchedule
		extends Schedule<org.nd4j.linalg.schedule.ExponentialSchedule> {
	...
	@Override public void setBackend(org.nd4j.linalg.schedule.ExponentialSchedule newBackend) {
