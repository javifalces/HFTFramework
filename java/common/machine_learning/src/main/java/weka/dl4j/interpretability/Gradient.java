...
public class Gradient {
	 ...
	 */
	public final static Color[] GRADIENT_PLASMA = createMultiGradient(
			new Color[] { new Color(11, 1, 116), new Color(188, 46, 102), new Color(240, 250, 29) }, 500);
	...
	public final static Color[] GRADIENT_HEAT = createMultiGradient(
			new Color[] { Color.black, new Color(105, 0, 0), new Color(192, 23, 0), new Color(255, 150, 38),
					Color.white }, 500);
