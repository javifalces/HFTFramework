 ...
 * @author Eibe Frank
 */
@JsonTypeName("SquaredHinge") public class LossSquaredHinge
		extends LossFunction<org.nd4j.linalg.lossfunctions.impl.LossSquaredHinge> implements OptionHandler {
