...
public class DropoutLayer extends FeedForwardLayer<org.deeplearning4j.nn.conf.layers.DropoutLayer>
	...
	@OptionMetadata(displayName = "dropout", description = "The dropout method to use (default = Dropout(0.8)).", commandLineParamName = "dropout", commandLineParamSynopsis = "-dropout <Dropout>", displayOrder = 25) public AbstractDropout getDropout() {
