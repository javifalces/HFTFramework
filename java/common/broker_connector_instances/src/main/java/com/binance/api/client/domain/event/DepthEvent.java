 ...
 */
@JsonIgnoreProperties(ignoreUnknown = true) public class DepthEvent {
	...
	@JsonProperty("U") private long firstUpdateId;

	/**
	 * updateId to sync up with updateid in /api/v1/depth
	 */
	@JsonProperty("u") private long finalUpdateId;

	/**
	 * Bid depth delta.
	 */
	@JsonProperty("b") private List<OrderBookEntry> bids;

	/**
	 * Ask depth delta.
	 */
	@JsonProperty("a") private List<OrderBookEntry> asks;
	 ...
	 */
	@Deprecated public long getUpdateId() {
		return finalUpdateId;
	}
	 ...
	 */
	@Deprecated public void setUpdateId(long updateId) {
