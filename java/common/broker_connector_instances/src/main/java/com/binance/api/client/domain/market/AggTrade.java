 ...
 */
@JsonIgnoreProperties(ignoreUnknown = true) public class AggTrade {
	...
	@JsonProperty("f") private long firstBreakdownTradeId;

	@JsonProperty("l") private long lastBreakdownTradeId;
