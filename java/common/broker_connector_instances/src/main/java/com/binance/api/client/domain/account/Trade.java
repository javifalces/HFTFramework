 ...
 */
@JsonIgnoreProperties(ignoreUnknown = true) public class Trade {
	...
	@JsonProperty("isBuyer") private boolean buyer;

	@JsonProperty("isMaker") private boolean maker;

	@JsonProperty("isBestMatch") private boolean bestMatch;
	...
	@JsonSetter("id") public void setId(Long id) {
		this.id = id;
	}

	@JsonSetter("tradeId") public void setTradeId(Long id) {
		if (this.id == null) {
			setId(id);
		}
	}
