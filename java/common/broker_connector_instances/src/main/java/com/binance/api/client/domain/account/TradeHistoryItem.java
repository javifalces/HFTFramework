 ...
 */
@JsonIgnoreProperties(ignoreUnknown = true) public class TradeHistoryItem {
	 ...
	 * Is buyer maker ?
	 */
	@JsonProperty("isBuyerMaker") private boolean isBuyerMaker;

	/**
	 * Is best match ?
	 */
	@JsonProperty("isBestMatch") private boolean isBestMatch;
