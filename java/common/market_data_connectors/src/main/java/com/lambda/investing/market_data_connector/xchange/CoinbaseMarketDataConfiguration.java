...
@Getter @Setter public class CoinbaseMarketDataConfiguration implements MarketDataConfiguration {
	...
	public CoinbaseMarketDataConfiguration(String apiKey, String secretKey) {
		this.apiKey = apiKey;
