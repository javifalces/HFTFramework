"""
Run Alpha Avellaneda-Stoikov strategy through the ZeroMQ launcher.
...
From repository root:
    ...
    python -m python_algo.examples.run_alpha_as_zeromq
...
def _build_settings(instrument: str) -> dict:
    ...
    algorithm_name = f"alpha_as_{instrument}_{now_tag}"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run alpha_as via zeromq_trading launcher")
