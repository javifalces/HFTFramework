...
LAMBDA_OUTPUT_PATH=os.getenv(key='LAMBDA_OUTPUT_PATH',default=str(PROJECT_PATH)+os.sep+'output')
LAMBDA_INPUT_PATH=os.getenv(key='LAMBDA_INPUT_PATH',default=str(PROJECT_PATH)+os.sep+'input')
...
default_zero_jar_path = str(pathlib.Path(PROJECT_PATH).parent)+os.sep+os.path.join('java','executables','AlgoTradingZeroMq','target','AlgoTradingZeroMq.jar')
