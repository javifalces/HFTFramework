#%%
from trading_algorithms.avellaneda_stoikov import AvellanedaStoikov
...
parameters_1 = {"risk_aversion": 0.9, "window_tick": 3, "spread_multiplier": 1.0}
avellaneda_stoikov_1.set_parameters(parameters_1)

avellaneda_stoikov_2 = AvellanedaStoikov(algorithm_info='test_main_2')
parameters_2 = {"risk_aversion": 0.1, "window_tick": 33, "spread_multiplier": 4.0}
